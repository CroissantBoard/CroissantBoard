...
@NgModule({
  declarations: [ExampleSvgIconComponent, GoogleIconComponent, FacebookIconComponent],
  imports: [RouterModule],
  exports: [ExampleSvgIconComponent, GoogleIconComponent, FacebookIconComponent]
})
